            ...
            >
                <div class="relative">
                    ...
                    <dd class="mt-2 ml-16 text-base text-gray-500">
                        I started learning right before the Vue 3 release. So I
                        have to re-crawl the entire documentation and course for
                        up to date myself.
                    </dd>
                </div>
                ...
                <div class="relative">
                    ...
                    <dd class="mt-2 ml-16 text-base text-gray-500">
                        ...
                        transaction handling and auth. For front-end I picked
                        PUG templating with SSR.
                    </dd>
                </div>
